...
function parallaxSpiderWoman(scrollPosition){
    spiderWomanParallax.style.transform = `translateX(${-scrollPosition*0.4}px) translateY(${-scrollPosition*0.4}px)`;
}

function parallaxSpiderMenAndTelarañaDer(scrollPosition){
    spiderMenParallax.style.transform = `translateX(${scrollPosition*0.2}px) translateY(${-scrollPosition*0.2}px)`;
    telaDerParallax.style.transform = `translateX(${scrollPosition*0.2}px) translateY(${-scrollPosition*0.2}px)`;
}

function parallaxSpiderAndTelarañaIzq(scrollPosition){
    spiderParallax.style.transform = `translateX(${-scrollPosition*0.2}px) translateY(${-scrollPosition*0.2}px)`;
    telaIzqParallax.style.transform = `translateX(${-scrollPosition*0.2}px) translateY(${-scrollPosition*0.2}px)`;
}

function parallaxEstructuraIzq(scrollPosition){
    estructuraIzqParallax.style.transform = `translateX(${-scrollPosition*0.3}px) translateY(${scrollPosition*0.8}px)`;
}

function parallaxEstructuraDer(scrollPosition){
    estructuraDerParallax.style.transform = `translateX(${scrollPosition*0.3}px) translateY(${scrollPosition*0.8}px)`;
}

function parallaxEstructuraAbajo(scrollPosition){
    estructuraAbajoParallax.style.transform = `translateY(${scrollPosition*0.4}px)`;
}
